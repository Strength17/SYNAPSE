...
│  Phase        : P-01 — BACKEND FOUNDATION                           │
│  Current Task : P-01-T01                                             │
│  Status       : PENDING                                              │
...
| P-01-T08 | Test health endpoint | ⬜ | |

## PHASE 2 — OAUTH & AUTH

| ID | Task | Status | Notes |
|----|------|--------|-------|
| P-02-T01 | Google OAuth routes | ⬜ | |
| P-02-T02 | Microsoft OAuth routes | ⬜ | |
| P-02-T03 | POST /auth/logout | ⬜ | |
| P-02-T04 | GET /auth/me | ⬜ | |
| P-02-T05 | Token refresh logic | ⬜ | |
| P-02-T06 | Test Google OAuth | ⬜ | |
...
| P-03-T04 | services/outlook.js — fetchEmails | ⬜ | |
| P-03-T05 | services/outlook.js — detectCategory + getEmailBody | ⬜ | |
...
| P-05-T02 | Background sync scheduler | ⬜ | |
| P-05-T03 | SSE disconnect cleanup | ⬜ | |
...
| ID | Task | Status | Notes |
|----|------|--------|-------|
| P-08-T01 | main.js (full boot + wiring) | ⬜ | Hardest file |
...
| May 2026 | After each phase: commit + push + lessons + summary + await "next phase" |